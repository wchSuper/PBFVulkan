...
void main() {
    ...
    // Assuming metallic is in B channel and roughness is in G channel.
    vec3 pbr_props = texture(metallicRoughnessMap, TexCoord).rgb;
    float roughness = pbr_props.g;
    float metallic = pbr_props.b;
